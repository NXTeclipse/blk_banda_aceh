...
import com.example.catatanpenjualan.MenuAdapter
import com.example.catatanpenjualan.R


class DataBarangAdapter (val barang:List<Barang?>?, val onMenuClicked: OnMenuClicked)
    :RecyclerView.Adapter<DataBarangAdapter.MyHolder>(){
    ...
    interface OnMenuClicked{
        fun click(menultem: MenuItem, barang: Barang?)
    }
